            ...
            <tr>
                ...
                <td>
                    <div class="button-container">
                        ...
                        <button class="btn btn-info kartu" data-href="{{ route('alat.show.biologi', $alat->id_t_inventarisasi_alat) }}">Kartu</button>
                    </div>
                </td>
            </tr>
            @endforeach
...
$(document).ready(function() {
    ...
    $(document).on('click', '.edit-button', function() {
        var id = $(this).data('id');
        $.get('/inventarisasi-alat-biologi/' + id + '/edit', function(data) {
            $('#modalLabel').text('Edit Alat');
            $('#form').attr('action', '/inventarisasi-alat-biologi/' + id);
    ...
    $(document).on('click', '.delete-button', function() {
        if (confirm('Are you sure you want to delete this item?')) {
            ...
            $.ajax({
                type: 'POST',
                url: '/inventarisasi-alat-biologi/' + id,
                data: {
                    _token: '{{ csrf_token() }}',
                    _method: 'DELETE'
                },
