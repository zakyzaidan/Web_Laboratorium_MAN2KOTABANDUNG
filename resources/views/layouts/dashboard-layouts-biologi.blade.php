...
<body>
    <header class="navbar-container">
        <nav class="nav-list">
            <ul>
                <li>
                <a href="/Dashboard-inventaris-biologi/"><h2>Laboratorium Biologi MAN 2</h2></a>
                </li>
    ...
    <main>
        <aside>
            ...
            <div class="jadwal">
                <p><a href="/jadwal-praktikum-biologi/">Jadwal Praktikum</a> <i class="fas fa-chevron-right"></i></p>
            </div>
            <div class="jadwal">
            ...
            <div class="jadwal">
                <p><a href="/data-guru">Data Guru</a> <i class="fas fa-chevron-right"></i></p>
            </div>
        </aside>
        @yield('page')
    </main>
