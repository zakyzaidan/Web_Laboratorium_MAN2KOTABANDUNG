...
$(document).ready(function() {
    ...
    $('#addButton').click(function() {
        ...
        $('#form').attr('action', '{{ route('tenaga.store.fisika') }}');
    ...
    $(document).on('click', '.edit-button', function() {
        var id = $(this).data('id');
        $.get('/tenaga-laboratorium-fisika/' + id + '/edit', function(data) {
            $('#modalLabel').text('Edit Tenaga');
            $('#form').attr('action', '/tenaga-laboratorium-fisika/' + id);
    ...
    $(document).on('click', '.delete-button', function() {
        if (confirm('Are you sure you want to delete this item?')) {
            ...
            $.ajax({
                type: 'POST',
                url: '/tenaga-laboratorium-fisika/' + id,
                data: {
                    _token: '{{ csrf_token() }}',
                    _method: 'DELETE'
                },
