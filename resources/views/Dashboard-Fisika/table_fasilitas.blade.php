...
$(document).ready(function() {
    ...
    $('#addButton').click(function() {
        ...
        $('#form').attr('action', '{{ route('fasilitas.store.fisika') }}');
    ...
    $(document).on('click', '.edit-button', function() {
        var id = $(this).data('id');
        $.get('/inventarisasi-fasilitas-fisika/' + id + '/edit', function(data) {
            $('#modalLabel').text('Edit fasilitas');
            $('#form').attr('action', '/inventarisasi-fasilitas-fisika/' + id);
    ...
    $(document).on('click', '.delete-button', function() {
        if (confirm('Are you sure you want to delete this item?')) {
            ...
            $.ajax({
                type: 'POST',
                url: '/inventarisasi-fasilitas-fisika/' + id,
                data: {
                    _token: '{{ csrf_token() }}',
                    _method: 'DELETE'
                },
