            ...
            <tr>
                ...
                <td>
                    <div class="button-container">
                        ...
                        <button class="btn btn-info kartu" data-href="{{ route('alat.show.fisika', $alat->id_t_inventarisasi_alat) }}">Kartu</button>
                    </div>
                </td>
            </tr>
            @endforeach
...
$(document).ready(function() {
    ...
    $('#addButton').click(function() {
        ...
        $('#form').attr('action', '{{ route('alat.store.fisika') }}');
    ...
    $(document).on('click', '.edit-button', function() {
        var id = $(this).data('id');
        $.get('/inventarisasi-alat-fisika/' + id + '/edit', function(data) {
            $('#modalLabel').text('Edit Alat');
            $('#form').attr('action', '/inventarisasi-alat-fisika/' + id);
    ...
    $(document).on('click', '.delete-button', function() {
        if (confirm('Are you sure you want to delete this item?')) {
            ...
            $.ajax({
                type: 'POST',
                url: '/inventarisasi-alat-fisika/' + id,
                data: {
                    _token: '{{ csrf_token() }}',
                    _method: 'DELETE'
                },
