            ...
            <tr>
                ...
                <td>
                    <div class="button-container">
                        ...
                        <button class="btn btn-info kartu" data-href="{{ route('bahan.show.fisika', $bahan->id_t_inventarisasi_bahan) }}">Kartu</button>
                    </div>
                </td>
            </tr>
            @endforeach
...
$(document).ready(function() {
    ...
    $('#addButton').click(function() {
        ...
        $('#form').attr('action', '{{ route('bahan.store.fisika') }}');
    ...
    $(document).on('click', '.edit-button', function() {
        var id = $(this).data('id');
        $.get('/inventarisasi-bahan-fisika/' + id + '/edit', function(data) {
            $('#modalLabel').text('Edit Bahan');
            $('#form').attr('action', '/inventarisasi-bahan-fisika/' + id);
    ...
    $(document).on('click', '.delete-button', function() {
        if (confirm('Are you sure you want to delete this item?')) {
            ...
            $.ajax({
                type: 'POST',
                url: '/inventarisasi-bahan-fisika/' + id,
                data: {
                    _token: '{{ csrf_token() }}',
                    _method: 'DELETE'
                },
...
document.getElementById('exportButton').addEventListener('click', function() {
    window.location.href = '/export-bahan';
});
