...
class PeminjamanPihakLuar extends Model
{
    use HasFactory;

    // Nama tabel yang terhubung dengan model
    protected $table = 'kimia_peminjaman_pihak_luar';
    ...
    {
        return $this->belongsToMany(InventarisasiAlat::class, 'kimia_peminjamanluar_alat', 'peminjamanluar_id', 'alat_id')->withPivot('jumlah');
    }
}
