...
class BiologiInventarisasiBahanController extends Controller
{
    /**
    ...
    {
        $bahanList = BiologiInventarisasiBahan::all();
        return view('Dashboard-Biologi/table_bahan', compact('bahanList'));
    }
    ...
    public function store(Request $request)
    {
        ...
        BiologiInventarisasiBahan::create([
    ...
    {
        $bahan = BiologiInventarisasiBahan::find($id);
        return view('Dashboard-Biologi/detail_bahan', compact('bahan'));
    }
    ...
    {
        try {
            $bahan = BiologiInventarisasiBahan::findOrFail($id);
