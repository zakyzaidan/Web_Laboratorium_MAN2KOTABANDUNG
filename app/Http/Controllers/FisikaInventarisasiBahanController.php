...
class FisikaInventarisasiBahanController extends Controller
{
    /**
    ...
    {
        $bahanList = FisikaInventarisasiBahan::all();
        return view('Dashboard-Fisika/table_bahan', compact('bahanList'));
    }
    ...
    public function store(Request $request)
    {
        ...
        FisikaInventarisasiBahan::create([
    ...
    {
        $bahan = FisikaInventarisasiBahan::find($id);
        return view('Dashboard-Fisika/detail_bahan', compact('bahan'));
    }
    ...
    {
        try {
            $bahan = FisikaInventarisasiBahan::findOrFail($id);
