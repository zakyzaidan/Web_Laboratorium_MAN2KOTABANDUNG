...
class InventarisasiAlatController extends Controller
{
    public function index()
    {
        $alatList = InventarisasiAlat::all();
        return view('Dashboard/table_alat', compact('alatList'));
    }

    public function create()
    {
        return view('Dashboard/table_alat');
    }
    ...
    public function store(Request $request)
{
    ...
    {
        try {
            $alat = InventarisasiAlat::findOrFail($id);
