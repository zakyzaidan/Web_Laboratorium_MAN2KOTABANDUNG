...
class InventarisasiFasilitasController extends Controller
{
    /**
    ...
    {
        $fasilitasList = InventarisasiFasilitas::all();
        return view('Dashboard/table_fasilitas', compact('fasilitasList'));
    }
    ...
    {
        $fasilitas = InventarisasiFasilitas::find($id);
        return view('Dashboard/table_fasilitas', compact('fasilitas'));
    }
    ...
    {
        try {
            $fasilitas = InventarisasiFasilitas::findOrFail($id);
