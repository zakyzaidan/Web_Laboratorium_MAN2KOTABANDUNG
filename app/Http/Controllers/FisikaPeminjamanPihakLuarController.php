...
use App\Models\FisikaPeminjamanPihakLuar;
use App\Models\FisikaInventarisasiAlat;
use Illuminate\Support\Facades\Storage;
use Carbon\Carbon;

class FisikaPeminjamanPihakLuarController extends Controller
{
    /**
    ...
    {
        $peminjamanList = FisikaPeminjamanPihakLuar::all();
        $alats = FisikaInventarisasiAlat::all();
        return view('Dashboard-Fisika/table_peminjaman', compact('peminjamanList', 'alats'));
    }
    ...
    {
        return view('Dashboard-Fisika/table_bahan');
    }
    ...
    public function store(Request $request)
    {
        ...
        $peminjaman = FisikaPeminjamanPihakLuar::create([
    ...
    {
        $peminjaman = FisikaPeminjamanPihakLuar::find($id);
        return view('Dashboard-Fisika/table_peminjaman', compact('peminjaman'));
    }
    ...
    {
        $peminjam = FisikaPeminjamanPihakLuar::findOrFail($id);
    ...
    {
        $peminjam = FisikaPeminjamanPihakLuar::find($id);
        ...
        foreach ($peminjam->alat as $alatDikembalikan) {
            $alat = FisikaInventarisasiAlat::find($alatDikembalikan->id_t_inventarisasi_alat);
