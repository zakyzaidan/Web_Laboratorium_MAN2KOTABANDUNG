...
class FisikaInventarisasiFasilitasController extends Controller
{
    /**
    ...
    {
        $fasilitasList = FisikaInventarisasiFasilitas::all();
        return view('Dashboard-Fisika/table_fasilitas', compact('fasilitasList'));
    }
    ...
    {
        return view('Dashboard-Fisika/table_fasilitas');
    }
    ...
    public function store(Request $request)
    {
        ...
        FisikaInventarisasiFasilitas::create([
    ...
    {
        $fasilitas = FisikaInventarisasiFasilitas::find($id);
        return view('Dashboard-Fisika/table_fasilitas', compact('fasilitas'));
    }
    ...
    {
        try {
            $fasilitas = FisikaInventarisasiFasilitas::findOrFail($id);
