...
class BiologiTenagaLaboratoriumController extends Controller
{
    /**
    ...
    {
        $tenagaList = BiologiTenagaLaboratorium::all();
        return view('Dashboard-Biologi/table_tenaga', compact('tenagaList'));
    }
    ...
    {
        return view('Dashboard-Biologi/table_tenaga');
    }
    ...
    public function store(Request $request)
    {
        ...
        BiologiTenagaLaboratorium::create([
            'nama' => $request->nama,
    ...
    {
        $tenaga = BiologiTenagaLaboratorium::find($id);
        return view('Dashboard-Biologi/table_tenaga', compact('tenaga'));
    }
    ...
    {
        try {
            $tenaga = BiologiTenagaLaboratorium::findOrFail($id);
