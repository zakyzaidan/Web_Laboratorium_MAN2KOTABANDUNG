...
class BiologiInventarisasiController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $jumlahAlatBaik = BiologiInventarisasiAlat::sum('kondisi_baik');
        $jumlahAlatBuruk = BiologiInventarisasiAlat::sum('kondisi_buruk');

        // Mengambil jumlah data dari tabel t_inventarisasi_bahan dengan kondisi baik dan buruk
        $jumlahBahanBaik = BiologiInventarisasiBahan::sum('kondisi_baik');
        $jumlahBahanBuruk = BiologiInventarisasiBahan::sum('kondisi_buruk');

        // Mengambil jumlah data dari tabel t_inventarisasi_fasilitas dengan kondisi baik dan buruk
        $jumlahFasilitasBaik = BiologiInventarisasiFasilitas::sum('kondisi_baik');
        $jumlahFasilitasBuruk = BiologiInventarisasiFasilitas::sum('kondisi_buruk');

        // Mengambil jumlah tenaga laboratorium
        $jumlahTenagaLaboratorium = BiologiTenagaLaboratorium::count();
        ...
        return view('Dashboard-Biologi/inventaris', compact(
