...
function showSlides2() {
    ...
    updateSlideIndex(slides.length);

    var lebarLayar = window.innerWidth;
    slides[slide1Index2].style.display = "block";
    if (lebarLayar > 900 && slide2Index2 < slides.length) {
        slides[slide2Index2].style.display = "block";
    }
    if (lebarLayar > 1300 && slide3Index2 < slides.length) {
        slides[slide3Index2].style.display = "block";
    }
}

function updateSlideIndex(slidesLength) {
    if (slide3Index2 >= slidesLength) {
        slide1Index2 = 0;
        slide2Index2 = 1;
        slide3Index2 = 2;
    }
    if (slide1Index2 < 0) {
        slide1Index2 = slidesLength - 3;
        slide2Index2 = slidesLength - 2;
        slide3Index2 = slidesLength - 1;
    }
}
